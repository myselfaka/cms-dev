...
<h2 >Subscribe via email</h2>
 ...
 <p >Enter your email address :</p><p><input type="text" style="width:140px;" name="email"  /></p><input type="hidden" value="OnlineComputerTeacherKrachi" name="url"  /><input type="hidden" name="loc" value="en_Us" /><input type="submit" value="subscribe" /><p> </form>
 <!--Social buttons-->
